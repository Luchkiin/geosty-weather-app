...
namespace Geosty.Views
{
    ...
    public partial class DailyWeatherPage : ContentPage
    {
        ...
        async void TodayBarTapped(object sender, EventArgs e)
        {
